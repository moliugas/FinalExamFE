    ...
    var b = function(b) {
        ...
        c = function(c) {
            ...
            var d = this,
                ...
                g = function(b) {
                    ...
                    switch (console.log("fieldValue = ", c, "selfValue = ", e, b), b) {
                        case "==":
                            return g ? h : c == e;
                        case "!=":
                            return g ? !h : c != e;
        ...
        e = function(a) {
            ...
            var b = this,
                ...
                e = function() {
                    var a, e, f, g;
                    for (c = [], a = 0, e = b.logics.length; e > a; a++) g = b.logics[a], g.disabled || "" == g.selector || (f = new d(g), c.push(f))
                },
                f = function() {
...
function(a) {
    ...
    function() {
        function a() {
            var a = $(".submit p.error");
            a.data("origMsg") || a.data("origMsg", a.html()), a.html(a.data("origMsg")), a.show()
        }
        ...
        function c(a) {
            ...
            return "1" == b.data("nocsrf") ? !0 : void $.get(e, function(a) {
                try {
                    a = $.parseJSON(a)
                } catch (c) {
                    return
        ...
        function g(b) {
            var c = function(a) {
                    ...
                    c.closest("div.form-group").addClass("bg-info has-error" + (d ? " has-feedback" : "")), c.is(":visible") && d && !c.data("glyphicon") && ($('<span class="glyphicon glyphicon-warning-sign form-control-feedback" aria-hidden="true"></span>').insertAfter(c), c.data("glyphicon", !0), setTimeout(function() {
                        ...
                        g.offset(h)
                    }, 50)), h($.Event("invalid-form"), $(b).data("validator"))
                },
                d = function(a) {
                    $(a).data("glyphicon", !1), $(a).closest("div.form-group").removeClass("bg-info has-error has-feedback").find("span.glyphicon,p.validation-error").remove(), h($.Event("invalid-form"), $(b).data("validator"))
                };
            ...
            var e = function(a, b) {
                ...
                h = function(b, c) {
                    ...
                    d && (a(), g.checkRequired()), d = c.numberOfInvalids(), d || $("p.error").hasClass("server-error") || $("p.error").hide()
                },
                i = {},
                j = function(a) {
                    try {
                ...
                m = function(a) {
                    if (null === location.href.match(/^https*/) && null === $(a).attr("action").match(/^https*/)) return $("h4.local-submit").length || $("<h4 style='padding:16px;' class='bg-info local-submit'>bbddbsjdb</h4>").appendTo($(".jf-form")), !1;
                    var b = $(".submit p.error"),
                        c = [];
                    if ($(a).find("div.required").not(".jf-hide,.jf-disabled").each(function() {
                            c.push($(this).data("fid"))
                        }), $("#serverValidationFields").val(c.join(",")), b.hide(), b.removeClass("server-error"), $btn = new l, $btn.showProgressBar(), "1" == $(a).data("noajax")) return !0;
                    var d = function() {
                        var c = $(a).ajaxSubmit(),
                            d = c.data("jqxhr");
                        d.done(function(c) {
                            ...
                            $btn.hideProgressBar(), "function" == typeof ajaxSubmitCallback && ajaxSubmitCallback(c), data && data.validated === !0 ? (i = data.fieldValues, "0" != $(a).data("thankyou") && ($(".jf-form").hide(), k(i))) : (d && b.html(c), b.addClass("server-error").show("slow"))
                        })
                    };
                    setTimeout(d(), 3e3)
                };
            ...
            var n = function() {
                ...
                o = 0 === String($(b).data("licensekey")).toUpperCase().indexOf("JF-");
            o ? $(".jf-copyright").remove() : (f(), setInterval(f, 1e4)), $(b).validate({
        ...
        function h(a) {
            $.jMaskGlobals.watchDataMask = !0, $(a).each(function(a, b) {
                ...
                $.each(["format", "weekStart", "startDate", "endDate", "startView", "minViewMode", "todayBtn", "clearBtn", "language", "orientation", "multidate", "multidateSeparator", "daysOfWeekDisabled", "calendarWeeks", "autoclose", "todayHighlight", "datesDisabled", "toggleActive", "defaultViewDate"], function(a, b) {
                    if (c = e.data("datepicker-" + b.toLowerCase())) switch (b) {
                        case "datesDisabled":
                            d[b] = String(c).split(",");
                            break;
        ...
        var j = {};
        j.init = function(a) {
            d(), i(), h(".datepicker"), e(), g(a), c(a), b(), $(document).trigger("JF.ready", {
                formId: a
            }), $.setResponsiveToImages($(a).find("img"))
        }, $.formlogic && $.formlogic.field && (j.field = $.formlogic.field), window.JF = j
    }(),
    function() {
        function a(a, b) {
